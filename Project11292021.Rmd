...
DAta<-readr::read_csv("/Users/Karthik/Documents/EMT_540/ETM-540/DataEntryFile.csv")
TS<- readr::read_csv("/Users/Karthik/Documents/EMT_540/ETM-540/StaffSKills.csv")
S<-t(TS)
TP<-readr::read_csv("/Users/Karthik/Documents/EMT_540/ETM-540/ProfitPerStaff.csv")
P<-t(TP)
Z<-readr::read_csv("/Users/Karthik/Documents/EMT_540/ETM-540/ProfitPerProjectPerClass.csv")
Td <- t(DAta) #t(DAta[1:7,3:8])
